...
def listDirectory(directory):
    ...
    file_names = list(filter(lambda x: x.endswith('.tmx'), file_names))
    return file_names
...
def main():
    ...
    for i in range(pietra):
        ...
        result_map_clean.append(czysty_plan)
        result_map_obstacles.append(czysty_plan)

    result_map_obstacles[result_map_obstacles == SCIANA] = MapObject.WALL
    result_map_obstacles[result_map_obstacles == SCHODY] = MapObject.STEPS
    result_map_obstacles[result_map_obstacles == PRZESZKODA] = MapObject.OBSTACLE
    result_map_obstacles[result_map_obstacles == CZLOWIEK] = MapObject.HUMAN
    result_map_obstacles[result_map_obstacles == PUSTO] = MapObject.EMPTY

    result_map_clean[result_map_clean == SCIANA] = MapObject.WALL
    result_map_clean[result_map_clean == SCHODY] = MapObject.STEPS
    result_map_clean[result_map_clean == PRZESZKODA] = MapObject.OBSTACLE
    result_map_clean[result_map_clean == CZLOWIEK] = MapObject.HUMAN
    result_map_clean[result_map_clean == PUSTO] = MapObject.EMPTY
